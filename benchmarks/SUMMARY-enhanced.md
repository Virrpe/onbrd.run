...
**Context:** Testing enhanced reporter with context
...
node scripts/report-benchmarks.mjs --results="benchmarks/results.json" --eval="benchmarks/eval.json" --out="benchmarks/SUMMARY-enhanced.md" --context="Testing enhanced reporter with context"
```
...
- **Output Path:** `benchmarks/SUMMARY-enhanced.md`
- **Generated:** 2025-09-26T19:04:35.466Z
